...
TOPIC_KEYWORDS = {
    ...
    "quality": ["QUALITY_ASSESSMENTS", "IST_FULL_WEBSITE_MANUAL"],
    "qec": ["QUALITY_ASSESSMENTS", "IST_FULL_WEBSITE_MANUAL"],
    "assessment": ["QUALITY_ASSESSMENTS", "IST_FULL_WEBSITE_MANUAL"],
    "accreditation": ["QUALITY_ASSESSMENTS", "IST_FULL_WEBSITE_MANUAL"],
    "self assessment": ["QUALITY_ASSESSMENTS"],
    "sar": ["QUALITY_ASSESSMENTS"],
    "timing": ["ADMISSION_INFO"],
    "timings": ["ADMISSION_INFO"],
    "time": ["ADMISSION_INFO"],
    "hours": ["ADMISSION_INFO"],
    "open": ["ADMISSION_INFO", "ADMISSION_DATES_AND_STATUS"],
    "contact": ["ADMISSION_INFO"],
}
